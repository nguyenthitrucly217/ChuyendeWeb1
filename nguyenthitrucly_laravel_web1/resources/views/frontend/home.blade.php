...
<body>
    ...
    <div id="demo" class="carousel slide" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="./assets/img/bg2.jpg" alt="Slider1">
            ...
            <div class="carousel-item">
                <img src="./assets/img/bg3.jpg" alt="Slider2">
                <div class="carousel-caption d-none d-md-block">
            ...
            <div class="carousel-item">
                <img src="./assets/img/tl9.jpg" alt="Slider3">
                <div class="carousel-caption d-none d-md-block">
    ...
    <div class="container">
        <div id="category">
            <ul class="navbar-nav me-auto mb-2">
                <li class="nav-item ml-3"><a href="#">Hoa Tulip</a></li>
                    ...
                    <div class="card-body">
                        <div class="rating">
                            ...
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <a href="chi-tiet-san-pham/hoa-tulip" class="btn btn-success d-md-block"><i
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="rating">
                            ...
                            <div class="row">
                                <div class="col">
                                    <h4 class="discount-price">210.000vnd</h4>
                                </div>
                                <div class="col">
                                    <h4 class="price text-danger">199.000vnd</h4>
                                </div>
                            </div>
                            <p class="card-text">Hoa tulip có tên khoa học là Tulipa, là một loài cây thuộc chi thực vật
                                có hoa thuộc họ Liliaceae.</p>
    ...
    <div class="container">
        <footer>
            <div class="row">
                <div class="col-sm-3">
                    <div className="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">
                        <h5 className="footer text-center">Tuclie Shop</h5>
                        <img src="./assets/img/logo.png" className="img-fluid" alt="LOGO" />
                        <h6 className='text-danger'>
                            HOA TƯƠI & LỌ TRANG TRÍ
                        </h6>
                        <p>Số điện thoại: 0836706514</p>
                        <p>Địa chỉ: Đường số 8, Phường Tăng Nhơn Phú B, Quận 9, TPHCM</p>
            ...
            <hr>
            <h6 class="text-center"> Tuclie - Nguyễn Thị Trúc Ly - 2121110295</h6>
        </footer>
    </div>
    <!--End Footer-->
